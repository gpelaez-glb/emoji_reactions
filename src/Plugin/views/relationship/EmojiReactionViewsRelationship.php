...
namespace Drupal\emoji_reactions\Plugin\views\relationship;
 ...
 *
 * @ViewsRelationship("reaction_views_relationship")
 */
class EmojiReactionViewsRelationship extends RelationshipPluginBase {
  ...
  /**
   * Constructs a EmojiReactionViewsRelationship object.
   *
  ...
  public function defineOptions() {
    ...
    $options['emoji_reactions'] = ['default' => NULL];
  ...
  public function query() {
    ...
    if ($this->options['user_scope'] == 'current') {
      ...
      $roles = user_roles(FALSE, 'emoji_reactions_react');
